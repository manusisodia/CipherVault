    ...
    if request.method == "POST":
        if "signup_post" in request.POST:
            ...
            if pswd != pswd2:
                ...
                otp_purpose = "signup"
                send_mail(
                    "CipherVault Password Manager: Confirm Email",
            ...
            if input_otp != global_code:
                ...
                if(otp_purpose=="signup"):
                    ...
                    if not new_user==None:
                        ...
                        link = ""
                        message = format_html(
                            "Your account was successfully created.<br> Website Link -> <a href='{}'></a>", link
                        )
                        send_mail(
            ...
            if new_user is None:
                ...
                otp_purpose = "login"
                send_mail(
                    "CipherVault Password Manager: Confirm Login",
            ...
            if not User.objects.filter(email=email).exists():
                ...
                send_mail(
                    "CipherVault Password Manager: Passsword Reset",
            ...
            send_mail(
                "CipherVault Password Manager: Account Delete",
